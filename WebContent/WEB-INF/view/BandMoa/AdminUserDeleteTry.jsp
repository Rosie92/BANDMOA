...
<body>
    ...
    <div class="login-dark">
        ...
        <form name="s" id="s" method="post" action="/BandMoa/AdminUserDelete.do">
         	정말로 진행하시겠습니까?<br>
         	확인을 위해 관리자 비밀번호를<br>
        	입력해주세요.<br><br>
        ...
        <input class="btn btn-primary btn-block" style="cursor:pointer;" readonly="readonly"  value="탈퇴진행"></div>
        <a class="forgot" href="/BandMoa/AdminUserInfoModify.do?user_no=<%=pDTO.getUser_no()%>">돌아가기</a><br>
