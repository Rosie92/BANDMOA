...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
    BMMDTO pDTO = (BMMDTO)request.getAttribute("pDTO");
if(pDTO ==null){
	pDTO = new BMMDTO();
}
%>
...
<body style="overflow-x: hidden">
    ...
    <div style="width: 740px; margin: left;">
		...
		<form name="f" id="f" method="post" action="/BandMoa/ModifyCertify3M.do?seq=<%=seq%>">
        ...
        <%} else {%>
        <!-- 사용자 비밀번호 인증창 -->
        <form name="f" id="f" method="post" action="/BandMoa/ModifyCertify2M.do?seq=<%=seq%>">
		<input value="<%=seq%>" name="seq" hidden="hidden"><!-- 이거하면 서티파이2로 넘어갈것임 -->
        <h2 class="sr-only">ModifyCertify Form</h2>
        <br><br><br><br><br>
