...
<body style="overflow-x: hidden">
    ...
    <div style="width: 740px; margin: left;">
		...
		<form name="f" id="f" method="post" action="/BandMoa/CommentCertify2.do?rno=<%=rno%>">
        ...
        <a class="forgot" href="/BandMoa/FB/BMFreeB.do?Pno=1" width="40%">돌아가기</a>
        
        <%} else {%>
        <!-- 사용자 비밀번호 인증창 -->
        <form name="f" id="f" method="post" action="/BandMoa/CommentCertify.do?rno=<%=rno%>">
