...
<body style="overflow-x: hidden">
	...
	<form id="AAAA" name="AAAA" method="post" action="/BandMoa/CommentModifyGoSR.do<%-- ?rno=<%=pDTO.getRno() %> --%>">
	...
	<div class="form-group"> <!-- submit이 input에 들어가면 유효성 검사가 실행이X -->
        <input type="button" id="submitB" class="btn btn-primary btn-block" readonly="readonly" style="cursor:pointer;" value="작성완료"></div>
        	<a class="forgot" href="/BandMoa/CommentDeleteSR.do?rno=<%=rno %>">이 댓글 삭제하기 /<font color="red"> (주의)클릭 시 즉시 삭제됩니다.</font></a><br>
