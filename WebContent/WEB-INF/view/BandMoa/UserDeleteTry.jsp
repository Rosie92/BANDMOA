...
<body>
    ...
    <div class="login-dark">
        ...
        <form name="s" id="s" method="post" action="/BandMoa/UserDelete.do">
        	정말로 탈퇴하시겠습니까?<br>
        	확인을 위해 아이디와 비밀번호를<br>
        	입력해주세요.<br><br>
        <div class="form-group"><input class="form-control" type="text" name="user_id" id="user_id" value="ID"></div>
        ...
        <input class="btn btn-primary btn-block" style="cursor:pointer;" readonly="readonly"  value="회원 탈퇴하기"></div>
