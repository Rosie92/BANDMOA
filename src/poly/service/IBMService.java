...
public interface IBMService {
	...
	List<BMUserInfoDTO> getInserLogin_Join() throws Exception;
	...
	int getUserLoginCheck(BMUserInfoDTO pDTO) throws Exception;
	int UpdatePw(BMUserInfoDTO pDTO) throws Exception;
	int SelectIdFind(BMUserInfoDTO pDTO) throws Exception;
	int MypageModify2(BMUserInfoDTO pDTO) throws Exception;
	int UserMypageCertify(BMUserInfoDTO pDTO) throws Exception;
	...
	int BMFreeBDModify(BMFBDTO pDTO) throws Exception;
	int BMSrBDModify(BMSRDTO pDTO) throws Exception;
	int BMqtBDModify(BMQTDTO pDTO) throws Exception;
	int BMmBDModify(BMMDTO pDTO) throws Exception;
